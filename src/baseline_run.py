...
def run(_run, _config, _log):
    ...
    #         project="0812-MTMA",
    #         group=args.task,
    #         name=algorithm_name + "_dropout_" + str(args.token_dropout) + "_" + detail,
    #     )
...
def draw_mean_attention_heatmap(
    attention, task, num_steps_to_plot, batch_idx, first_dead
):
    import os
    import torch as th
    import numpy as np
    ...
    # ✅ figsize 넉넉하게 조정
    fig, axes = plt.subplots(
        A, num_steps_to_plot, figsize=(num_steps_to_plot * 4, A * 2)
    )
